...
use crate::RADIAL_DISSOLVE_PBR_HANDLE;
...
#[bind_group_data(RadialDissolveStandardMaterialKey)]
#[uniform(0, RadialDissolveStandardMaterialUniform)]
#[reflect(Default, Debug)]
pub struct RadialDissolveStandardMaterial {
    ...
    pub distort_speed: f32,
    pub distortion_amount: f32,
    pub ring_glow_amount: f32,
}

impl Default for RadialDissolveStandardMaterial {
    fn default() -> Self {
        RadialDissolveStandardMaterial {
            ...
            ring_glow_amount: 50.0,
        }
    }
}

impl From<Color> for RadialDissolveStandardMaterial {
...
impl From<Handle<Image>> for RadialDissolveStandardMaterial {
...
pub struct RadialDissolveStandardMaterialUniform {
    /// Doubles as diffuse albedo for non-metallic, specular for metallic and a mix for everything
    /// in between.
    pub base_color: Vec4,
    // Use a color for user friendliness even though we technically don't use the alpha channel
...
impl AsBindGroupShaderType<RadialDissolveStandardMaterialUniform>
    for RadialDissolveStandardMaterial
{
    fn as_bind_group_shader_type(
        ...
        RadialDissolveStandardMaterialUniform {
            ...
            alpha_cutoff,
            radius: self.radius,
            ring_color: self.ring_color.as_linear_rgba_f32().into(),
            ring_thickness: self.ring_thickness,
            distort_speed: self.distort_speed,
            distortion_amount: self.distortion_amount,
            ring_glow_amount: self.ring_glow_amount,
        }
    }
}

#[derive(Clone, PartialEq, Eq, Hash)]
pub struct RadialDissolveStandardMaterialKey {
    normal_map: bool,
    cull_mode: Option<Face>,
    depth_bias: i32,
}

impl From<&RadialDissolveStandardMaterial> for RadialDissolveStandardMaterialKey {
    fn from(material: &RadialDissolveStandardMaterial) -> Self {
        RadialDissolveStandardMaterialKey {
...
impl Material for RadialDissolveStandardMaterial {
    fn specialize(
